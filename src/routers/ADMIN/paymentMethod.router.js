...
paymentMethodRouter.post("/", validate("createUser"), paymentMethodController.createpaymentMethod)
paymentMethodRouter.patch("/:id", validate("idParams"), validate("createUser"), paymentMethodController.updatepaymentMethod)
