...
eventCategoriesRouter.post("/", validate("createUser"), eventCategoriesController.createEventCategories)
eventCategoriesRouter.patch("/:id", validate("idParams"), validate("createUser"), eventCategoriesController.updateEventCategories)
